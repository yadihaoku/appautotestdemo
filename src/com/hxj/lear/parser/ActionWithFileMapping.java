...
public class ActionWithFileMapping {
	...
	public static final String HEAD_CAPTURE = "截图";

	HashMap<String, Integer> mapping;
	
	public ActionWithFileMapping(List<String> row){
	...
	public int captureIndex(){
		if(mapping.containsKey(HEAD_CAPTURE))
			return mapping.get(HEAD_CAPTURE);
		else
			return -1;
	}
